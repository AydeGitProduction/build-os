/**
 * POST /api/admin/migrate-p11-5
 *
 * P11.5-b migration: creates wizard_sessions, wizard_steps, wizard_artifacts,
 * evaluation_scores, evaluation_criteria, evaluation_score_audit,
 * calibration_records, and provider_connections tables.
...
const DDL_STATEMENTS = [
  ...
  `REVOKE ALL ON public.wizard_sessions FROM anon`,
  ...
  `REVOKE ALL ON public.wizard_steps FROM anon`,
  ...
  `REVOKE ALL ON public.evaluation_scores FROM anon`,
